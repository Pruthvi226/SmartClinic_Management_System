...
INSERT INTO patients (id, name, dob, age, gender, phone, email, blood_group, address) VALUES
(1, 'Aarav Mehta', '1992-08-12', 33, 'MALE', '+91 98765 43210', 'aarav.mehta@example.com', 'O+', 'Bandra West, Mumbai'),
(2, 'Neha Sharma', '1988-03-24', 38, 'FEMALE', '+91 99887 77665', 'neha.sharma@example.com', 'A+', 'Indiranagar, Bengaluru'),
(3, 'Rohan Iyer', '1956-11-05', 69, 'MALE', '+91 91234 56789', 'rohan.iyer@example.com', 'B+', 'Adyar, Chennai'),
(4, 'Fatima Khan', '2001-01-17', 25, 'FEMALE', '+91 90123 45678', 'fatima.khan@example.com', 'AB+', 'Koregaon Park, Pune'),
(5, 'Vikram Rao', '1978-07-30', 47, 'MALE', '+91 93456 78120', 'vikram.rao@example.com', 'O-', 'Jubilee Hills, Hyderabad')
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    phone = VALUES(phone),
    email = VALUES(email),
...
INSERT INTO prescriptions (id, appointment_id, doctor_id, patient_id, diagnosis, issued_at) VALUES
(1, 5, 2, 5, 'Stable angina symptoms reviewed. ECG advised, lipid profile requested, and medication started.', DATE_SUB(NOW(), INTERVAL 2 DAY))
ON DUPLICATE KEY UPDATE
    diagnosis = VALUES(diagnosis),
    issued_at = VALUES(issued_at);

INSERT INTO prescription_items (id, prescription_id, medicine_name, dosage, duration, instructions) VALUES
(1, 1, 'Aspirin', '75 mg', '30 days', 'Take once daily after breakfast'),
(2, 1, 'Atorvastatin', '10 mg', '30 days', 'Take once at night'),
(3, 1, 'Pantoprazole', '40 mg', '14 days', 'Take before breakfast')
ON DUPLICATE KEY UPDATE
...
INSERT INTO billing (id, appointment_id, amount, tax, total, payment_status, generated_at) VALUES
(1, 5, 100.00, 18.00, 118.00, 'PAID', DATE_SUB(NOW(), INTERVAL 2 DAY))
ON DUPLICATE KEY UPDATE
