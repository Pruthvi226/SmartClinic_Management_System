    ...
    <table style="margin-top:1.5rem;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><strong>INR ${bill.total}</strong></td>
                ...
                <td>
                    ...
                    <a href="<c:url value='/billing/receipt/${bill.id}'/>" class="btn btn-secondary" style="padding:0.3rem 0.6rem;font-size:0.875rem;">Receipt</a>
                </td>
            </tr>
            </c:forEach>
