...
<div class="card">
    ...
    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 20px; margin-top: 2rem;">
        ...
        <div style="background: linear-gradient(135deg, #64748B 0%, #334155 100%); color:white; padding: 2rem; border-radius:16px;">
            <h3 style="margin:0; font-weight:400; font-size:1.1rem;">System Users</h3>
            <p style="font-size:3rem; font-weight:700; margin:0.5rem 0 0 0;">${userCount}</p>
        </div>
    </div>
    ...
    <div style="margin-top:2rem;">
        ...
        <a href="<c:url value='/admin/users'/>" class="btn btn-secondary" style="margin-right:1rem;">Users</a>
        <a href="<c:url value='/admin/departments'/>" class="btn btn-secondary" style="margin-right:1rem;">Departments</a>
        <a href="<c:url value='/admin/settings'/>" class="btn btn-secondary" style="margin-right:1rem;">Settings</a>
        <a href="<c:url value='/admin/reports'/>" class="btn btn-secondary" style="margin-right:1rem;">Daily Reports</a>
        <a href="<c:url value='/admin/revenue'/>" class="btn btn-secondary" style="margin-right:1rem;">Revenue Analytics</a>
